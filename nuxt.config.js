...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'og:type', name: 'og:type', content: 'website' },
      {
        ...
        name: 'og:image',
        content:
          'https://giricode.com/_ipx/f_webp,fit_fill,q_80,w_1000/storage/sliders/fSdgTkdPjKwyHJW7Ga9wro3p3HZ4Vt9RmDxIM10l.svg',
      },
      {
        hid: 'og:description',
        name: 'og:description',
  ...
  pwa: {
    meta: {
      title:
        'Giricode - Belajar koding bahasa Indonesia mulai dasar hingga expert.',
      author: 'Giricode',
      // 'theme-color': '#7BAE91',
